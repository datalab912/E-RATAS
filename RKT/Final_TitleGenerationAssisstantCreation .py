...
assistant = client.beta.assistants.create(
    ...
    instructions= 
    f"You are an expert responsible for find main feature of a provided criterion. I have a scoring criterion from a rubric and a corresponding answer. I want to identify the relevant parts of the answer that need to be evaluated against this criterion." 
    f"Please specify the features of the content that is related to the criterion. just give me the combination of words (like a title with less than 20 words) that shows this featureinvolves breaking down the provided criteria into simpler sub-criteria so that I can use these more straightforward sub-criteria to assess answers more easily."
    f"follow the instructions to generate the specific feature-based title" 
...
client.beta.threads.messages.create(
    ...
    role="user",
    content=(
        "Now, follow the instructions to generate the related feature-based title for the new criterion. The new provided rubric criterion is: Plan how the learning from doing tasks or assignments or activities will be useful to students"
    )
)
...
client.beta.threads.messages.create(
    ...
    role="user",
    content=(
        "very good, do again for the next provided rubric criterion and like the previous messages, follow the instructions and examples to generate the related feature-based title for the new criterion. The new provided rubric criterion is: The title page of the report must include:\na. Name of the organization\nb. Name of the internee, Student ID and session\nc. Submission date of the internship report\nd. Name of the University"
    )
)
...
#     role="user",
#     content=(
#         "very good, do again for the next provided rubric criterion and like the previous messages, follow the instructions of this thread and examples to generate the sub-criteria for the new provided criterion. The new provided rubric criterion is: The progress report should have weekly progress from week 1 to week 3 update sections (essential) including a summary of completed tasks and current in-progress tasks for the weeks."
#     )
# )
